...
#                 QSWATUtils.loginfo(line)
    ...
    def runTauDEM2(self, ver = None, reg = None, in_outlet_path = None, Mask_gpd = None, sel_file = None, subDir = None) -> None:
        ...
        if not self._dlg.useOutlets.isChecked():
            ...
            self.runTauDEM(outletFile, True, reg = reg, ver = ver, in_outlet_path = in_outlet_path, Mask_gpd = Mask_gpd, sel_file = sel_file, subDir = subDir)
    ...
    def runTauDEM(self, outletFile: Optional[str], makeWshed: bool, ver = None, reg = None, in_outlet_path = None, Mask_gpd = None, sel_file = None, subDir = None) -> None:
        """Run TauDEM."""
        self.delineationFinishedOK = False
        ...
        streamFile = QSWATUtils.dirToShapefile(shapesBase + 'stream.shp')
        ...
        if self._dlg.useOutlets.isChecked():
            ...
            if subDir is not None:
                os.system(f'python3 create-outlets.py {ver} {reg} --sr {subDir}')
            else:
