...
# os.system(f"python3 ../data-preparation/make-bounding-boxes.py {regions_}")

# create dem
os.system(f"python3 ../data-preparation/prepare-dem-aster.py {regions_}")

# create soil map based on dem
os.system(f"python3 ../data-preparation/prepare-soils.py {regions_}")

# create landuse map based on dem
os.system(f"python3 ../data-preparation/prepare-landuse.py {regions_}")

# create lake shapefile
os.system(f"python3 ../data-preparation/prepare-lakes-data.py {regions_}")

# create weather data
# os.system(f"prepare-weather.py {regions_}")

# get grdc stations
os.system(f"python3 ../data-preparation/get-grdc-stations.py {regions_}")
