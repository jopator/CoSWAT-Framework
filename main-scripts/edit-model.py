...
if __name__ == '__main__':
    ...
    for region in regions:
        ...
        write_to(cioFile, cioFileString.replace('time.sim          print.prt         null              object.cnt        null',
                                                'time.sim          print.prt         null              object.cnt        null              coswat.prt'))
        ...
        # create coswat.prt
        """
        coswat.prt: Print options for CoSWAT GHM
        object		timestep 	nvars 	varname
        """
        
        coswatPrtFile = f"{txtinout_dir}/coswat.prt"
        
        with open(coswatPrtFile, "w") as file:
            file.write("coswat.prt: Print options for CoSWAT GHM\n")
            file.write("object      timestep    nvars   varname\n")
