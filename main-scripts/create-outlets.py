...
grdc_shp_fn = f'../model-data/{variables.coswat_data_version}/{region}/shapes/grdc_stations-{proj_auth.upper()}-{proj_code}.gpkg'
...
points_template_fn = f"../resources/outlet-template-{proj_auth}-{proj_code}.gpkg"
...
# buffered_polygons       = lakesFN.geometry.buffer(0)     # Create a buffer around the polygons
