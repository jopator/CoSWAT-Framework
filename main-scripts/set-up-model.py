...
def set_up_model(region_, version_, get_data_, period_):
    ...
    if variables.include_lakes:
        os.system(f'python3 write-reservoirs.py {region_} --v {version_}')
        os.system(f'python3 write-irrigation.py {region_} --v {version_}')
...
if __name__ == "__main__":
    ...
    for region in regions:
        ...
        jobs.append([region, version, "n", variables.run_period])
        # jobs.append([region, version, variables.run_period])
