...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(f"! select a region for which to prepare the dataset. options are: {', '.join(list_folders('../resources/regions_v2/'))}\n")
        sys.exit()
    ...
    for region in regions:
        ...
        create_path(f'../model-data/{variables.coswat_data_version}/{region}/raster/')
