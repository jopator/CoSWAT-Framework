...
for region in regions:
    ...
    maskfn                  = "../resources/{region_source}/{baseRegion}/{region}/region_mask-{auth}-{code}.gpkg".format(**details)  #"./resources/regions/{region}/bounding-box-{auth}-{code}.gpkg".format(**details) #Changed name from regionfn to bboxgfn
    # regionfn                = "./resources/regions/{region}/outlets-buffer.gpkg".format(**details)

    mask_gdf                = gpd.read_file(maskfn)
