...
for region in regions:
    ...
    for index, row in final_grdc_stations_gpd.iterrows():
        ...
        if file_exists:
            ...
            create_path("../model-data/{coswat_data_version}/{region}/observations/".format(**details), v = False)
            ts_m_df.to_csv(f"../model-data/{variables.coswat_data_version}/{region}/observations/{row['grdc_no']}.csv")
